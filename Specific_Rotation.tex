...
\date{\vspace{-5ex}}
\rhead{\textsc{Experiment No.2}}
\lhead{St. Stephen's College, Delhi}
%-----------------------------------------------------------------------------
...
\begin{center}
\begin{tabular}{r l} % Alignment right and left
Date Performed: & October 20, 2015 \\ % Date the experiment was performed
Instructors: & Prof. A. Gupta \\  % Instructor/supervisor
			 & Prof. V. Vyas
\end{tabular}
\end{center}
...
\tableofcontents  % Compile twice after changes 
\thispagestyle{empty}  % Remove pagenumbers from this page 
...
\begin{figure}[h] \label{img:1} % Reference for this image: \ref{img:1}
